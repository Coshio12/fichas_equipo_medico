    ...
    <div class="modal-container w-full py-2 bg-white cursor-default pointer-events-auto relative rounded-xl mx-auto max-w-sm border-x-8   border-gray-700">
        ...
        <div class="space-y-2 p-2">
            <div class="p-2 space-y-2 text-center">
                <h2 class="text-xl font-bold tracking-tight" id="page-action.heading">Actualizar Area</h2>
            </div>
        </div>
        ...
        <div class="space-y-2">
            ...
            <div class="grid grid-cols-1 place-items-center px-4 py-2">
                ...
                <form id="edit-form" method="POST" class="space-y-4">
                    ...
                    <div>
                        <label for="nombre_area" class="mb-2 text-gray-400 text-lg">Nombre del Area
...
<script>
    ...
    const EditArea = document.getElementById('edit-nombre-area');
