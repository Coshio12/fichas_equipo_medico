<button {{ $attributes->merge(['type' => 'submit', 'class' => 'border-gray-600 border rounded-md inline-flex items-center justify-center py-3 px-7 text-center text-base font-medium text-dark  hover:bg-green-500 hover:text-white hover:border-white'])}}>
    <span {{ $attributes->merge(['class' => 'pr-3'])}}>
        <svg 
              width="20" 
              height="20" 
              viewBox="0 0 20 20" 
